...
public:
    ...
    {
        Randomize->setWindowTitle(QApplication::translate("Randomize", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("Randomize", "Ilo\305\233\304\207 losowa\305\204", Q_NULLPTR));
    } // retranslateUi
