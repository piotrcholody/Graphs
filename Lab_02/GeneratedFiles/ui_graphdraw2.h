...
public:
    ...
    {
        GraphDraw2->setWindowTitle(QApplication::translate("GraphDraw2", "GraphDraw2", Q_NULLPTR));
        actionImport_Graph->setText(QApplication::translate("GraphDraw2", "Import Graph", Q_NULLPTR));
        actionSave_Graph->setText(QApplication::translate("GraphDraw2", "Save Graph", Q_NULLPTR));
        actionGenerate_Vert_Edge->setText(QApplication::translate("GraphDraw2", "from vertices/edges", Q_NULLPTR));
        actionFrom_vertices_probability->setText(QApplication::translate("GraphDraw2", "from vertices/probability", Q_NULLPTR));
        actionFrom_k_regularity->setText(QApplication::translate("GraphDraw2", "from k-regularity", Q_NULLPTR));
        PBEulerian->setText(QApplication::translate("GraphDraw2", "Eulerian circle", Q_NULLPTR));
        PBHamiltonianC->setText(QApplication::translate("GraphDraw2", "Hamiltonian circle", Q_NULLPTR));
        PBRandomize->setText(QApplication::translate("GraphDraw2", "Randomize", Q_NULLPTR));
        PBInsertData->setText(QApplication::translate("GraphDraw2", "Insert data", Q_NULLPTR));
        PBDraw->setText(QApplication::translate("GraphDraw2", "Draw", Q_NULLPTR));
        PBConsistentSubG->setText(QApplication::translate("GraphDraw2", "Consistent subgraph", Q_NULLPTR));
        menuFile->setTitle(QApplication::translate("GraphDraw2", "File", Q_NULLPTR));
        menuGenerate_Graph->setTitle(QApplication::translate("GraphDraw2", "Generate Graph", Q_NULLPTR));
    } // retranslateUi
