...
public:
    ...
    {
        GGeneratork->setWindowTitle(QApplication::translate("GGeneratork", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("GGeneratork", "Vertices", Q_NULLPTR));
        label_2->setText(QApplication::translate("GGeneratork", "k", Q_NULLPTR));
    } // retranslateUi
