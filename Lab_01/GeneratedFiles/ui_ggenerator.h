...
public:
    ...
    {
        GGenerator->setWindowTitle(QApplication::translate("GGenerator", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("GGenerator", "Vertices", Q_NULLPTR));
        label_2->setText(QApplication::translate("GGenerator", "Edge probability", Q_NULLPTR));
    } // retranslateUi
