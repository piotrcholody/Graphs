...
int main( void ){
	...
	/*
	std::cout << "Tworzenie macierzy z zadana liczba wierzcholkow i krawedzi" << std::endl;
	IncidenceMatrix imatrix2(2, 2);
	imatrix2.setEntireMatrix();
	imatrix2.printEntireMatrix();
	*/
